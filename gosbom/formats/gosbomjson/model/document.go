...
// Document represents the gosbom cataloging findings as a JSON document
type Document struct {
	...
	Descriptor            Descriptor     `json:"descriptor"`        // Descriptor is a block containing self-describing information about gosbom
